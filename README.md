...
### Idle & Run
![Idle and Run](media/Idle_Run.gif)

### Jump & Double Jump
![Jump and Double Jump](media/Jump_Double_Jump.gif)

### Coyote Time & Jump Buffer
![Coyote Time and Jump Buffer](media/coyote_time_jump_buffer.gif)

### Ground & Air Dash
![Ground and Air Dash](media/Air_Ground_Dash.gif)

### Ground & Air Attacks (3-Hit Combos)
![Ground and Air Attacks](media/Air_Ground_Attack.gif)
